  ...
  <article class="group blog-card">
    <div class="p-6 flex flex-col min-w-0 justify-center sm:p-7">
      <h2 class="text-2xl leading-tight font-bold m-0 md:text-2xl">
        <NuxtLink class="inline-flex gap-3 transition-colors duration-150 items-start hover:text-current-2 focus-visible:outline-2 focus-visible:outline-fg-3 focus-visible:outline-offset-2" :to="post.path">
